...
(function($, window, document, undefined) {
	...
	Snowfall.prototype = {
		...
		defaults:{
			...
			verticalSpeed: 0.5,						//Somewhere between 0.5 and 10 works best
			...
			horizontalSpeed:-5,						//Somewhere between -10 and 10 works best, negative values for left moving particles
			...
			maxiumumRandomHorizontalSpeed:-0.5,		//Maxiumum horizontal speed, can be negative for moving to the left.
			...
			maximumWind:0.5,							//Maximun wind speed (can be negative)
			...
			maxiumRandomRadius:3,					//In case graphicMode false: maximum random radius
			graphics: [
				'img/flake.png',
				'img/flake2.png'
		...
		drawElements: function(){
			...
			//Set the fill style
			this.ctx.fillStyle = "rgba(204, 245, 255, 1)";
